...
class ChooseRounds:
    ...
    def __init__(self):
        ...
        choose_instructions_txt = "In each round you will be given the" \
                                  "name of a fear, and different meanings" \
                                  "of potential fears. Try to guess the correct" \
                                  "fear matching the name."
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        instructions = "Choose one of the fears below. When you choose " \
                       "a fear, it will be revealed whether you got the " \
